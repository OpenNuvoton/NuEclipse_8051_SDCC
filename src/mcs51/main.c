...
static struct pragma_s _mcs51_pragma_tbl[] = {
  {"codeseg", P_CODESEG, 0, _mcs51_do_pragma},
  {"constseg", P_CONSTSEG, 0, _mcs51_do_pragma},
  {NULL, 0, 0, NULL},
};
...
{
  return process_pragma_tbl (_mcs51_pragma_tbl, s);
}
...
static void
_mcs51_genAssemblerEnd (FILE *of)
{
...
static int
_mcs51_dwarfRegNum (const struct reg_info *reg)
{
  return reg->rIdx;
}
...
//    NULL                        /* no do_assemble function */
  ...
  _mcs51_genAssemblerEnd,                           /* no genAssemblerEnd */
  _mcs51_genIVT,
  _mcs51_genXINIT,
